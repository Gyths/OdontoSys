<%@ Page Title="Historial de pacientes" Language="C#" MasterPageFile="~/OdontoSys.Master" AutoEventWireup="true" CodeBehind="listar_pacientes.aspx.cs" Inherits="OdontoSysFrontEnd.listar_pacientes" %>
            ...
            <div class="col-md-12">
                <asp:GridView ID="dgvPacientes" runat="server" AllowPaging="true" PageSize="10" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Historia clínica">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbHistoriaClinica" runat="server" Text="Ver" 
