<%@ Page Title="" Language="C#" MasterPageFile="~/Paciente.Master" AutoEventWireup="true" CodeBehind="inicioSesion.aspx.cs" Inherits="OdontoSysWebApplication.inicioSesion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="login-form-side">
      <div class="login-card bg-white p-4 shadow-sm rounded">
        ...
        <asp:HyperLink runat="server" NavigateUrl="~/registro.aspx"
