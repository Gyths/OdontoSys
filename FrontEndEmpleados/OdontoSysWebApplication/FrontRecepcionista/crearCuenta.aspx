<%@ Page Title="" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="crearCuenta.aspx.cs" Inherits="OdontoSysWebApplication.crearCuenta" %>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-12">
            ...
            OnSelectedIndexChanged="ddlTipoCuenta_SelectedIndexChanged">
                ...
                <asp:ListItem Text="Odontólogo" Value="odontologo" />
            </asp:DropDownList>
          </div>
          ...
          <asp:Panel ID="panelOdontologo" runat="server" Visible="false">
