...
import com.odontosys.db.util.Cifrado;
import com.odontosys.db.util.MotorDeBaseDeDatos;
...
public abstract class DBManager {
    ...
    public Connection getConnection() {
        try {
            ...
            System.out.println(Cifrado.cifrarMD5("dbodontosys"));
